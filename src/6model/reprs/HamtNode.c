...
static const MVMREPROps VMHamtNode_this_repr;
...
{
    MVMSTable *st = MVM_gc_allocate_stable(tc, &VMHamtNode_this_repr, HOW);
...
static void VMHamtNode_gc_mark(MVMThreadContext *tc, MVMSTable *st, void *data,
...
// static MVMStorageSpec get_elem_storage_spec(MVMThreadContext *tc, MVMSTable
// *st)
// {
//     MVMHamtNodeREPRData *repr_data = (MVMHamtNodeREPRData *)st->REPR_data;
//     MVMStorageSpec spec;
